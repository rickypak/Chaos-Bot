...
bot.username = ('TestBot'); //bot name, change if you hate rappies :(
                  ...
                  if(randomINT <= 6){ 
                   ...
                   scrollValue2 = Math.floor(Math.random() * 11 - 5);
                    ...
                    if(database[i].spec1>0 && database[i].spec2>0){
                        message.channel.send("<:chaos:720794246386417665>");
...
bot.login("NzIwNDE2NjY5MjIyMDQzNjc5.XuHH3w.MIyaOkxblejocbpii8JzJZjDSiI");
